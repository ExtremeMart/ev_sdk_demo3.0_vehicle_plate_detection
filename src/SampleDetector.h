...
{            
    public:
        ...
        bool UnInit();        
        bool ProcessImage(const cv::Mat& img, std::vector< BoxInfo >& DetObjs, float thresh = 0.15);                   
    ...
    private:
        ...
        void generate_yolox_proposals(std::vector<GridAndStride> grid_strides, float* feat_blob, float prob_threshold, std::vector<BoxInfo>& objects);
